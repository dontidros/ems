    ...
    <div class="col-8">
      <form action="{{ url('cms/content') }}" method="POST" novalidate="novalidate" autocomplete="off">
        ...
        <div class="form-group">
          ...
          <input value="{{ old('ctitle') }}" type="text" name="ctitle" id="ctitle" class="form-control field-input-cms">
        ...
        <input type="submit" name="submit" class="btn btn-primary" value="Save Content">
      </form>
    </div>
  </div>
</div>
