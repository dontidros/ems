  ...
  <div class="row">
    <div class="col-8">
      ...
      <input type="hidden" name="item_id" value="{{ $category_item['id'] }}">
        ...
        <input type="text" value="{{ $category_item['url'] }}" name="url" id="url" class="form-control field-input-cms target-text">
        ...
        <div class="form-group">
        <img width="80px" src="{{ asset('images/' . $category_item['image']) }}" alt="category image">
        </div>
        <div class="input-group">
          ...
          <div class="custom-file">
            ...
            <label for="image" class="custom-file-label">Change Category Image</label>
          </div>
        </div>
        <div class="form-group">
